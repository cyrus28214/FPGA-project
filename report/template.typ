    ...
    align(
      ...
      box(
        width: 75%,
        {
          ...
          if (author != none) {
            buffer.push("姓" + full_space + full_space + "名")
            buffer.push(author)
          }
          if (school_id != none) {
            buffer.push("学" + full_space + full_space + "号")
            buffer.push(school_id)
          }
          if (college != none) {
            buffer.push("学" + full_space + full_space + "院")
            buffer.push(college)
          }
          if (major != none) {
            buffer.push("专" + full_space + full_space + "业")
            buffer.push(major)
          }
          if (teacher != none) {
            buffer.push("指导教师")
